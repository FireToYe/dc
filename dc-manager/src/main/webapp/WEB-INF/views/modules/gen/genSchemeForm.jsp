	...
	<form:form id="inputForm" modelAttribute="genScheme" action="${ctx}/gen/genScheme/save" method="post" class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-3 controls">
				...
				<span class="help-inline">建议模块包：com.zhilink.srm.modules</span>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-3 controls">
				<form:select path="genTable.id" class="required input-xlarge form-control">
					<form:options items="${tableList}" itemLabel="nameAndComments" itemValue="id" htmlEscape="false form-control"/>
				</form:select>
