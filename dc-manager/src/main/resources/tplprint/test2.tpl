...
<body>
    <div id="main">
		...
		<table class="detail">
			<tr>
				<td class="col1"><span class="tit">订单号：</span><span class="val">${detail.code}</span></td>
				<td class="col2"><span class="tit">单据日期：</span><span class="val">${detail.date}</span></td>
				<td class="col3"><span class="tit">单据类型：</span><span class="val">${detail.type}</span></td>
			</tr>
			<tr>
				<td><span class="tit">客户名称：</span><span class="val">${detail.custName}</span></td>
				<td><span class="tit">客户联系人：</span><span class="val">${detail.custLink}</span></td>
				<td><span class="tit">客户电话：</span><span class="val">${detail.custTel}</span></td>
			</tr>
			<tr>
				<td><span class="tit">供应商名称：</span><span class="val">${detail.vendorName}</span></td>
				<td><span class="tit">供应商联系人：</span><span class="val">${detail.vendorLink}</span></td>
				<td><span class="tit">供应商电话：</span><span class="val">${detail.vendorTel}</span></td>
			</tr>
		</table>
		...
		<table class="list">
			...
			<tbody>
				#foreach ($element in ${detail.items})
				<tr >
		...
		<br/>
		<div>
			<img class="qrcode" src="" value="${detail.code}" width="120px" />
			<span>带二维码</span>
		</div>
		<br/>
		<div>
